...
There’s the other side of the coin, the side I’m on, that says the quality of audio description does matter.

I am not alone in this thinking, that AD quality matters. [Here is a YouTube video talking about the importance of keeping human AD narrators, going far beyond quality](https://www.youtube.com/watch?v=MzUh0X761SQ)

Back to the TTS advocates, these TTS audio description advocates also think that in a few more years, humans will never be needed to make audio description again because machines will be super good at it. Good luck when the next tech hype comes about and leaves so called AI in the dust and leaves you without access, but let’s explore the process of audio description.
...
In most cases, audio description is provided as a compliance assurance. The craft of audio description is never or rarely considered. [These samples of AD showcase the lack of attention to the craft if TTS is used.](https://adp.acb.org/samples) It’s just a compliance thing, corporations think, it isn’t a form of art, or it doesn’t have layers to it. There are people that also think this way too, but the denigration happens because people want to just be done with audio description. They don’t care if we get the information, because they’re compliant. Why should they care if we get all the information?

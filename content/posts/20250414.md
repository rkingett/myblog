...
As if the above wasn't enough, that's just how YouTube harms it's users. [There's a bunch more ways YouTube harms it's users](https://en.wikipedia.org/wiki/YouTube_moderation) and also its creators, you know, the people that make the service what it is.
